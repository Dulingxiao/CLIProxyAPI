...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/capabilities", s.mgmt.GetManagementCapabilities)
		mgmt.GET("/codex/overdraft/status", s.mgmt.GetCodexOverdraftStatus)
		mgmt.GET("/codex/overdraft/enabled", s.mgmt.GetCodexOverdraftSwitch)
		mgmt.PATCH("/codex/overdraft/enabled", s.mgmt.PatchCodexOverdraftSwitch)
		mgmt.GET("/codex/quota", s.mgmt.GetCodexQuotaSnapshots)
		mgmt.GET("/codex/quota/health", s.mgmt.GetCodexQuotaHealth)
		mgmt.GET("/codex/quota/debug", s.mgmt.GetCodexQuotaDebug)
		mgmt.POST("/codex/quota/:auth_id/refresh", s.mgmt.PostCodexQuotaRefresh)
		mgmt.GET("/codex/upstream-failures", s.mgmt.GetCodexUpstreamFailures)
		mgmt.GET("/accounting/health", s.mgmt.GetAccountingHealth)
		mgmt.GET("/accounting/events", s.mgmt.GetAccountingEvents)
		mgmt.GET("/accounting/costs", s.mgmt.GetAccountingCosts)
		mgmt.GET("/accounting/aggregate", s.mgmt.GetAccountingAggregate)
		mgmt.GET("/accounting/aggregates", s.mgmt.GetAccountingAggregates)
		mgmt.PUT("/model-pricing", s.mgmt.PutModelPrice)
		mgmt.GET("/model-pricing", s.mgmt.ListModelPrices)
		mgmt.POST("/model-pricing/reprice", s.mgmt.PostModelReprice)
		mgmt.GET("/model-pricing/:version_id", s.mgmt.GetModelPrice)
